#
#  Be sure to run `pod spec lint Neeman.podspec' to ensure this is a
...
3. Set the **User Defined Runtime Attribute** `rootURLString` to the URL you which to display.
  ...
  s.license      = { :type => "INTELLIM", :file => "LICENSE" }
  ...
  # Or just: s.author    = "Stephen Williams"
  # s.authors            = { "Stephen Williams" => "swilliams@intellum.com" }
  # s.social_media_url   = "http://twitter.com/intellum"
  ...
  s.source       = { :git => "https://github.com/intellum/neeman-internal.git", :tag => "#{s.version}" }
